...
import com.jap.eCommerce.Jap_ECom.model.dto.security.JapEComUserDetails;
...
public class JWTAuthenticationFilter extends OncePerRequestFilter {
    ...
    private UsernamePasswordAuthenticationToken getAuthenticationFromMobileNo(String userName, Collection<SimpleGrantedAuthority> authorities) {
        ...
        try {
            userDTO = this.securityService.getUserByMobileUserName(userName);
        } catch (Exception e) {
            LOG.warn("Getting user for {} failed", userName);
        }

        JapEComUserDetails userDetails = new JapEComUserDetails(userDTO);
